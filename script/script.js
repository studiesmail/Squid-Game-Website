  window.addEventListener('load',function(){
    ...
    new Box(-1,2,'../images/');
    new Box(0,2,'../images/');
    new Box(1,2,'../images/001.png');
    new Box(2,2,'../images/');
    new Box(3,2,'../images/Kang.png');
    new Box(4,2,'');
    new Box(5,2,'../images/doll.png');
    new Box(2,-2,'../images/frontman.png');
    new Box(2,-1,'../images/group.png');
    new Box(2,0,'../images/101.jpg');
    new Box(2,1,'../images/frontman.jpg');
    new Box(2,2,'../images/365.jpg');
    new Box(2,3,'../images/thanos.png');
    new Box(2,4,'');
    new Box(2,5,'');
